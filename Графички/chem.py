...
radius = 6*mm
NA = radius  / z0/2  #numerical aperture
...
F = MonochromaticField(
    wavelength=600 * nm, extent_x=1.5 * mm, extent_y=1.5 * mm, Nx=2048, Ny=2048,intensity = 0.2
)

F.add(ApertureFromImage("E:\Code\Projects Python\ДАня мельник проект\Gleb\Screenshot_1.png",  image_size = (1.0 * mm, 1.0 * mm), simulation = F))
